...
| **Hexadecimal**                               | **RGB**         | **Use**                                                      |
| :-------------------------------------------- | :-------------- | :----------------------------------------------------------- |
| ![alt text](color-codes/f7768e.gif)`#f7768e`  | `247, 118, 142` | This keyword, HTML elements, Regex group symbol, CSS units, Terminal Red |
| ![alt text](color-codes/ff9e64.gif)`#ff9e64`  | `255, 158, 100` | Number and Boolean constants, Language support constants     |
| ![alt text](color-codes/e0af68.gif)`#e0af68`  | `224, 175, 104` | Function parameters, Regex character sets, Terminal Yellow   |
| ![alt image](color-codes/cfc9c2.gif)`#cfc9c2` | `207, 201, 194` | Parameters inside functions (semantic highlighting only)     |
| ![alt text](color-codes/9ece6a.gif)`#9ece6a`  | `158, 206, 106` | Strings, CSS class names                                     |
| ![alt text](color-codes/73daca.gif)`#73daca`  | `115, 218, 202` | Object literal keys, Markdown links, Terminal Green          |
| ![alt text](color-codes/b4f8f8.gif)`#b4f9f8`  | `180, 249, 248` | Regex literal strings                                        |
| ![alt text](color-codes/2ac3de.gif)`#2ac3de`  | `42, 195, 222`  | Language support functions, CSS HTML elements                |
| ![alt text](color-codes/7dcfff.gif)`#7dcfff`  | `125, 207, 255` | Object properties, Regex quantifiers and flags, Markdown headings, Terminal Cyan, Markdown code, Import/export keywords |
| ![alt text](color-codes/7aa2f7.gif)`#7aa2f7`  | `122, 162, 247` | Function names, CSS property names, Terminal Blue            |
| ![alt text](color-codes/bb9af7.gif)`#bb9af7`  | `187, 154, 247` | Control Keywords, Storage Types, Regex symbols and operators, HTML Attributes, Terminal Magenta |
| ![alt text](color-codes/c0caf5.gif)`#c0caf5`  | `192, 202, 245` | Variables, Class names, Terminal White                       |
| ![alt text](color-codes/a9b1d6.gif)`#a9b1d6`  | `169, 177, 214` | Editor Foreground                                            |
| ![alt text](color-codes/9aa5ce.gif)`#9aa5ce`  | `154, 165, 206` | Markdown Text, HTML Text                                     |
| ![alt text](color-codes/565f89.gif)`#565f89`  | `86, 95, 137`   | Comments                                                     |
| ![alt text](color-codes/414868.gif)`#414868`  | `65, 72, 104`   | Terminal Black                                               |
| ![alt text](color-codes/24283b.gif)`#24283b`  | `36, 40, 59`    | Editor Background (Storm)                                    |
| ![alt text](color-codes/1a1b26.gif)`#1a1b26`  | `26, 27, 38`    | Editor Background (Night)                                    |

### Tokyo Night Light
| **Hexadecimal**                               | **RGB**         | **Use**                                                      |
| :-------------------------------------------- | :-------------- | :----------------------------------------------------------- |
| ![alt image](color-codes/8c4351.gif)`#8c4351` | `140, 67, 81`   | This keyword, HTML elements, Regex group symbol, CSS units, Terminal Red |
| ![alt image](color-codes/965027.gif)`#965027` | `150, 80, 39`   | Number and Boolean constants, Language support constants     |
| ![alt image](color-codes/8f5e15.gif)`#8f5e15` | `143, 94, 21`   | Function parameters, Regex character sets, Terminal Yellow   |
| ![alt image](color-codes/634f30.gif)`#634f30` | `99, 79, 48`    | Parameters inside functions (semantic highlighting only)     |
| ![alt image](color-codes/385f0d.gif)`#385f0d` | `56, 95, 13`    | Strings, CSS class names                                     |
| ![alt image](color-codes/33635c.gif)`#33635c` | `51, 99, 92`    | Object literal keys, Markdown links, Regex literal strings, Terminal Green |
| ![alt image](color-codes/006c86.gif)`#006c86` | `0, 108, 134`   | Language support functions, CSS HTML elements                |
| ![alt image](color-codes/0f4b6e.gif)`#0f4b6e` | `15, 75, 110`   | Object properties, Regex quantifiers and flags, Terminal Cyan, Markdown code, Import/export keywords |
| ![alt image](color-codes/2959aa.gif)`#2959aa` | `41, 89, 170`   | Function names, CSS property names, Markdown Headings, Terminal Blue |
| ![alt image](color-codes/5a3e8e.gif)`#5a3e8e` | `90, 62, 142`   | Control Keywords, Storage Types, Regex symbols and operators, HTML Attributes, Terminal Magenta |
| ![alt image](color-codes/343b58.gif)`#343b58` | `52, 59, 88`    | Editor Foreground, Variables, Class names, Terminal White    |
| ![alt image](color-codes/40434f.gif)`#40434f` | `64, 67, 79`    | Markdown Text, HTML Text                                     |
| ![alt image](color-codes/343b58.gif)`#343B58` | `52, 59, 88`    | Terminal Black                                               |
| ![alt image](color-codes/6c6e75.gif)`#6c6e75` | `108, 110, 117` | Comments                                                     |
| ![alt image](color-codes/e6e7ed.gif)`#e6e7ed` | `230, 231, 237` | Editor Background                                            |
### Terminals 
...
+ [Yazi](https://github.com/BennyOe/tokyo-night.yazi) -BennyOe
